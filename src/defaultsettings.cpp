...
void set_default_settings(Settings *settings)
{
	...
	settings->setDefault("motd", "Welcome Minetest-M13 Player");
	settings->setDefault("max_users", "10");
	...
	settings->setDefault("max_simultaneous_block_sends_per_client", "1");
	settings->setDefault("max_simultaneous_block_sends_server_total", "5");
	settings->setDefault("max_block_send_distance", "2");
	settings->setDefault("max_block_generate_distance", "3");
	settings->setDefault("time_send_interval", "20");
	settings->setDefault("time_speed", "96");
	settings->setDefault("server_unload_unused_data_timeout", "29");
	settings->setDefault("server_map_save_interval", "25.3");
